return {
  ...
  },
  {
    ...
    config = function()
        ...
        handlers = {
          ...
          ["basedpyright"] = function()
            local pyright_capabilities =
              vim.deepcopy(capabilities or vim.lsp.protocol.make_client_capabilities())

            -- Override publishDiagnostics for Pyright
            pyright_capabilities.textDocument.publishDiagnostics = pyright_capabilities.textDocument.publishDiagnostics
              or {}
      ...
      local function setup_hover_handler()
